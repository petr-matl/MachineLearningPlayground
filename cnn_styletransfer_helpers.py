...
class CONFIG:
    ...
    VGG_MODEL = 'datasets/imagenet-vgg-verydeep-19.mat' # Pick the VGG 19-layer model by from the paper "Very Deep Convolutional Networks for Large-Scale Image Recognition".
...
def model_nn(sess, input_image, model, train_step, J, J_content, J_style, num_iterations = 200):
    ...
    for i in range(num_iterations):
        ...
        if i%20 == 0:
            ...
            save_image("datasets/output/" + str(i) + ".png", generated_image)
    
    # save last generated image
    save_image('datasets/generated_image.jpg', generated_image)
